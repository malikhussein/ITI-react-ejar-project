...
import RelatedProducts from '../../components/relatedItem/relatedItem';
...
export default function Wishlist() {
  ...
  return (
    <>
      <div
        className="container mt-4 wishlist-page "
      ...
      >
        ...
        {wishlist.length > 0 && (
          <button
            ...
            className="btn btn mb-3 float-end"
            style={{ color: 'white', backgroundColor: '#562DDD', margin: 10 }}
          >
